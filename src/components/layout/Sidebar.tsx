            ...
            >
                <div className="flex items-center justify-between px-6 pt-8 pb-4 shrink-0">
                    <div className="flex items-center gap-2">
                        <div className="w-8 h-8 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl rotate-12 shadow-lg shadow-indigo-500/20 flex items-center justify-center">
                            <Zap className="h-4 w-4 text-white -rotate-12" />
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            onClick={onClose}
                            className="lg:hidden rounded-xl p-1.5 text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition-colors"
                        >
                            <X className="h-4 w-4" />
                        </button>
                    </div>
                        ...
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                cn(
                                    ...
                                    isActive
                                        ? "glass-nav-active text-accent-indigo shadow-sm"
                ...
                <div className="px-4 pb-6 pt-4 space-y-2 shrink-0">
                    ...
                    <div className="bg-glass border border-glass-border rounded-[1.5rem] p-4 flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-accent-indigo to-accent-purple flex items-center justify-center text-white text-sm font-black shadow-md shadow-indigo-500/20 shrink-0">
                            {initials}
                        </div>
